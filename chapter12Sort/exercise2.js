// create an array of 1,000 integers already sorted into numeric order, runs each sorting algorithm with this array and timing
// also compare to the times for sorting an array in random order
...
elapsed = stop - start;
console.log("Elapsed time for the Bubble Sort on " + length + " integers in numeric order is: " + elapsed + " milliseconds.");
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Bubble Sort on " + length + " integers in random order is: " + elapsed + " milliseconds.");
console.log();
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Selection Sort on " + length + " integers in numeric order is: " + elapsed + " milliseconds.");
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Selection Sort on " + length + " integers in random order is: " + elapsed + " milliseconds.");
console.log();
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Insertion Sort on " + length + " integers in numeric order is: " + elapsed + " milliseconds.");
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Insertion Sort on " + length + " integers in random order is: " + elapsed + " milliseconds.");
console.log();
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Shell Sort on " + length + " integers in numeric order is: " + elapsed + " milliseconds.");
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Shell Sort on " + length + " integers in random order is: " + elapsed + " milliseconds.");
console.log();
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Merge Sort on " + length + " integers in numeric order is: " + elapsed + " milliseconds.");
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Merge Sort on " + length + " integers in random order is: " + elapsed + " milliseconds.");
console.log();
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Quick Sort on " + length + " integers in numeric order is: " + elapsed + " milliseconds.");
...
stop = new Date().getTime();
elapsed = stop - start;
console.log("Elapsed time for the Quick Sort on " + length + " integers in random order is: " + elapsed + " milliseconds.");
