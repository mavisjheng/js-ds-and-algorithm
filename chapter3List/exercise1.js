// inserts an element into a list only if the element to be inserted is larger than any of the elements currently in the list
// new functions are added: findMax, compare, and largestInsert
function List() {
  ...
  this.largestInsert = largestInsert;
  ...
  // compare function will use findMax() function as a helper funciton
  ...
  // largestInsert() function will use compare() function as a helper funciton
  function largestInsert(element) {
    var largest = this.compare(element);
    if(largest) {
      this.dataStore[this.listSize++] = element;
...
clients.largestInsert("Zucchini");
console.log(clients.toString());
